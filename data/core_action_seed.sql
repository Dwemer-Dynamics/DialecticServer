...
INSERT INTO public.core_action (
    ...
    ('FollowPlayer', 'Follow_#PLAYER_NAME#', '#DIALECTIC_NAME# follows #PLAYER_NAME#.', '#DIALECTIC_NAME# follows #PLAYER_NAME#.', TRUE, FALSE, FALSE, TRUE, '{"type":"object","required":[],"properties":{"target":{"type":"string","description":"Keep blank."}}}'::jsonb, '{"source":"functions.php","status":"active","builtin":true,"dispatch":"plugin_command","cooldown_seconds":30}'::jsonb, TRUE, 0, NULL),
    ...
    ('MakeFollower', 'Join_#PLAYER_NAME#_Party', '#DIALECTIC_NAME# joins #PLAYER_NAME# as a follower.', '#DIALECTIC_NAME# is now part of the adventuring party.', TRUE, FALSE, FALSE, TRUE, '{"type":"object","required":[],"properties":{"target":{"type":"string","description":"Keep blank."}}}'::jsonb, '{"source":"functions.php","status":"active","builtin":true,"dispatch":"plugin_command"}'::jsonb, TRUE, 0, NULL),
    ...
    ('KillTarget', 'Kill_Target', 'Kill a chosen nearby actor immediately. #PLAYER_NAME# and essential actors are protected.', '#TARGET# is killed.', FALSE, FALSE, TRUE, FALSE, '{"type":"object","required":["target"],"properties":{"target":{"type":"string","description":"Nearby non-player actor to kill."}}}'::jsonb, '{"source":"functions.php","status":"active","builtin":true,"dispatch":"plugin_command"}'::jsonb, TRUE, 0, NULL),

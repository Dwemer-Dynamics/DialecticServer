...
INSERT INTO public.core_action (
    ...
    ('Follow', 'Follow', 'Temporarily move to and follow the specified target actor without joining the party or follower roster. Do not use for requests to join the party or become a companion; use Join_#PLAYER_NAME#_Party.', '#DIALECTIC_NAME# follows #TARGET#.', TRUE, TRUE, FALSE, TRUE, '{"type":"object","required":["target"],"properties":{"target":{"type":"string","description":"Target NPC, actor, or being to follow."}}}'::jsonb, '{"source":"functions.php","status":"active","builtin":true,"dispatch":"plugin_command","cooldown_seconds":30}'::jsonb, TRUE, 0, NULL),
    ('FollowPlayer', 'Follow_#PLAYER_NAME#', '#DIALECTIC_NAME# temporarily follows #PLAYER_NAME# without joining the party or follower roster. Do not use for requests to join the party or become a companion; use Join_#PLAYER_NAME#_Party.', '#DIALECTIC_NAME# follows #PLAYER_NAME#.', TRUE, FALSE, FALSE, TRUE, '{"type":"object","required":[],"properties":{"target":{"type":"string","description":"Keep blank."}}}'::jsonb, '{"source":"functions.php","status":"active","builtin":true,"dispatch":"plugin_command","cooldown_seconds":30}'::jsonb, TRUE, 0, NULL),
    ('StopFollowing', 'Stop_Following_#PLAYER_NAME#', '#DIALECTIC_NAME# stops following #PLAYER_NAME# and leaves the current follower role.', '#DIALECTIC_NAME# stops following #PLAYER_NAME#.', TRUE, TRUE, FALSE, TRUE, '{"type":"object","required":[],"properties":{"target":{"type":"string","description":"Keep blank."}}}'::jsonb, '{"source":"functions.php","status":"active","builtin":true,"dispatch":"plugin_command","cooldown_seconds":30,"followup":{"enabled":false}}'::jsonb, TRUE, 0, NULL),
    ...
    ('MakeFollower', 'Join_#PLAYER_NAME#_Party', '#DIALECTIC_NAME# joins #PLAYER_NAME# as a recruited follower and party member, and begins following. Use for requests to join the party, become a follower or companion, join the squad, or travel as an ally.', '#DIALECTIC_NAME# is now part of the adventuring party.', TRUE, FALSE, FALSE, TRUE, '{"type":"object","required":[],"properties":{"target":{"type":"string","description":"Keep blank."}}}'::jsonb, '{"source":"functions.php","status":"active","builtin":true,"dispatch":"plugin_command"}'::jsonb, TRUE, 0, NULL),

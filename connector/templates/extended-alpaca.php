...
$context="{$GLOBALS["DIALECTIC_NAME"]}'s Persona: {$GLOBALS["DIALECTIC_PERS"]}\n";
            $context.="{$GLOBALS["PLAYER_NAME"]}'s Persona: {$GLOBALS["PLAYER_NAME"]}\n";
            $context.="Scenario: {$GLOBALS["PROMPT_HEAD"]} \n";
            $context.="Play the role of {$GLOBALS["DIALECTIC_NAME"]}. You must engage in a roleplaying chat with {$GLOBALS["PLAYER_NAME"]} below this line.Do not write dialogues for {$GLOBALS["PLAYER_NAME"]} and don't write narration.\n";

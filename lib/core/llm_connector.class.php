...
if (!function_exists('dialecticConnectorExtraParametersEnabled')) {
    function dialecticConnectorExtraParametersEnabled(array $connector): bool
    {
...
if (!function_exists('dialecticGetEnabledConnectorExtraParameters')) {
    function dialecticGetEnabledConnectorExtraParameters(array $connector): array
    {
        if (!dialecticConnectorExtraParametersEnabled($connector)) {
            return [];
        }

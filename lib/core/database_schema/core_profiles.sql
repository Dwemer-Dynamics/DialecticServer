...
INSERT INTO public.core_profiles (
    ...
    6,
    NULL,
    '{"RECHAT_H":"4","RECHAT_P":"100","RECHAT_ALLOW_ACTIONS":true,"DYNAMIC_PROFILE_FIELDS":["personality","speechstyle","goals"],"RPG_COMMENTS":["levelup","combat_end","lockpick","sleep"],"RPG_COMMENTS_CHANCE":50,"COMBAT_BARK_COOLDOWN":30,"AUTO_DIARY_ENABLED":false,"AUTO_DIARY_WAIT_ENABLED":true,"SALUTATION_AFTER_A_WHILE":false}',
    1,
    1,
    NULL
);

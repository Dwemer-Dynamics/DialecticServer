...
INSERT INTO public.core_tts_connector VALUES (1, 'pockettts', 'ddistro pockettts', '{"_title": "PocketTTS (Installed in DwemerDistro)", "voiceid": {"type": "string", "helpurl": "xtts_clone.php", "description": "Generated voice file name. Click the help link to go to voice management."}, "endpoint": {"type": "url", "helpurl": "https://dwemerdynamics.com/dialectic/tts.html#PocketTts", "description": "Endpoint URL. Python PocketTTS uses dedicated port 8024; audio.cpp uses port 8086. Click the help link to learn more."}, "language": {"type": "select", "values": ["ar", "pt", "zh-cn", "cs", "nl", "en", "fr", "de", "it", "pl", "ru", "es", "tr", "ja", "ko", "hu", "hi"], "description": "Language"}, "voicelogic": {"type": "select", "scope": "global", "values": ["voicetype", "name"], "description": "Default profile only. Logic used for generating [TTS POCKETTTS voiceid] <br> voicetype = NPC voicetype ID (FemaleAdult01) <br> name = NPC name (doc_mitchell)"}}', NULL, 'http://127.0.0.1:8024', 'voiceid');
INSERT INTO public.core_tts_connector VALUES (2, 'omnivoice', 'OmniVoice Default', '{"language": "en", "voicelogic": "voicetype", "fallback_male": "maleadult02", "fallback_female": "femaleadult02"}', NULL, 'http://127.0.0.1:8021', 'voiceid');

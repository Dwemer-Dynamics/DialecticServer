...
COMMENT ON COLUMN public.core_narrator.id IS 'Narrator setting key (e.g., enabled, welcome_enabled, random_enabled, random_chance, random_cooldown, hide_from_context)';

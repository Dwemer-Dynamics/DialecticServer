...
function pth_fresh_policy(): array {
    return [
        'keep' => explode(',', 'core_action,core_action_custom,core_api_badge,core_itt_connector,core_llm_connector,core_narrator,core_profiles,core_stt_connector,core_tts_connector,core_tts_pronunciation,database_versioning,game_plugins,import_rules,prompts,worldknowledge,worldknowledge_catalogs,worldknowledge_context_rule'),
        'empty' => explode(',', 'actions_issued,audit_memory,audit_request,core_npc_master_history,core_player,diarylog,eventlog,factions,locations,log,memory,memory_summary,moods_issued,quests,relationship_eval_queue,relationship_init_queue,responselog,rolemaster,speech,visual_context,worldknowledge_audit'),

...
<style>
    @font-face {
        ...
        src: url('<?php echo h($webRoot); ?>/ui/css/font/Gothic821CondensedRegular.otf') format('opentype');
        font-weight: normal;
        font-style: normal;
    }
    ...
    .btn-linklike:hover {
        background: rgba(255, 182, 65, 0.22);
    }
    ...
    .modal-head {
        ...
        gap: 16px;
        padding: 16px 18px;
        border-bottom: 1px solid rgba(255, 182, 65, 0.25);

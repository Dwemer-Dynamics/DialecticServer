<?php
if (defined('DIALECTIC_AUTO_SWITCH_CONTROL')) return;
define('DIALECTIC_AUTO_SWITCH_CONTROL', true);
...
<div class="pth-auto" data-endpoint="<?= $autoRoot ?>/ui/api/playthrough_manager.php">
    ...
    <small id="pth-auto-help">Match your loaded Fallout character and save the current playthrough before switching.</small>

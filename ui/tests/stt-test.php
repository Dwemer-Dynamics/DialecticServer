...
$TITLE = "DIALECTIC - STT Test - DIALECTIC Server";
...
function sttTestCollectDebugInfo(string $testFile): array
{
 ...
 $info = [
 'service' => $driver,
 'active_connector_id' => function_exists('dialecticGetGeneralSettingInt')
 ? dialecticGetGeneralSettingInt('GLOBAL_STT_CONNECTOR_ID', 0)
 : 0,
 'test_file' => $testFile,
...
if (php_sapi_name() != "cli") {
 ...
 ?><!DOCTYPE html><html><head><title><?php echo $TITLE; ?></title><link rel="icon" type="image/x-icon" href="../images/favicon.ico"><link rel="stylesheet" href="../css/main.css"><style>

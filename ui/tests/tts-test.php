...
$testStringDefault = "Patrolling the Mojave almost makes you wish for a Nuclear Winter.";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $connector) {
    ...
    $originalName = $GLOBALS["DIALECTIC_NAME"] ?? '';
...
.card h1, .card h2 { margin-top: 0; color: rgb(255, 182, 65); }
.field { margin-bottom: 12px; }
.field label { display: block; margin-bottom: 6px; color: rgb(255, 182, 65); font-weight: 600; }
    ...
    <div class="shell">
        ...
        <?php if ($connector): ?>
            <form method="post" class="card">
                ...
                <button type="submit" class="btn-save">Generate & Play</button>
            </form>
        <?php endif; ?>

...
//$filename = $enginePath . "data" . DIRECTORY_SEPARATOR . "pictures" . DIRECTORY_SEPARATOR . "gallery" . DIRECTORY_SEPARATOR . "t.png";
 ...
 $base64data = $generate_result["choices"][0]["message"]["images"][0]["image_url"]["url"];
    $filename = $enginePath . "data" . DIRECTORY_SEPARATOR . "pictures" . DIRECTORY_SEPARATOR . "gallery" . DIRECTORY_SEPARATOR . uniqid('image_or_', true) . '.png';

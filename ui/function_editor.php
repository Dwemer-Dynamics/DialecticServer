...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["action"])) {
    if ($_POST["action"] === "toggle_action") {
        ...
        if (!function_exists("dialecticActionCatalogDbReady") || !dialecticActionCatalogDbReady()) {
            ...
            || !function_exists("dialecticActionCatalogUpsertCustomParameters")
            || (count($configFields) > 0 && !function_exists("dialecticActionCatalogUpsertCustomConfig"))) {
            ...
            if ($errorMessage !== "") {
                ...
                if ($transactionStarted) {
                    ...
                    if ($saved && count($configFields) > 0) {
                        $saved = dialecticActionCatalogUpsertCustomConfig($codeName, $configValues);
                    }
                    if ($saved) {
                        $saved = dialecticActionCatalogUpsertCustomParameters($codeName, $normalizedParameters);
                    }
                }
...
<style>
    @font-face {
        ...
        src: url("<?php echo $webRoot; ?>/ui/css/font/MonofontoRg.otf") format("opentype");
        font-weight: normal;
        font-style: normal;
    }
    main {

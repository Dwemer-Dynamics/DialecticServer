...
$savedHiddenTypes = $applySavedFilters ? dialecticGetPersistedEventLogHiddenTypes($db) : [];
$eventLogOrderBy = dialecticGetEventLogUiOrderBy();

// Base event type filter for the DialecticServer Events page.
$typeFilter = dialecticBuildVisibleEventLogWhereClause($db, $selectedEventType, $savedHiddenTypes);
...
// Total count for pagination describes the eventlog table.
...
$columnHeaders = [
    'type' => 'Event',
    'data' => 'Events',
    'gamets' => $rawFormat ? 'Fallout Time' : '<a href="https://fallout.fandom.com/wiki/Timeline" target="_blank" style="color: yellow;">Fallout Time</a>',
    'localts' => 'Time (UTC)',
    'ts' => 'TS',
];

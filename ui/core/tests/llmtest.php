...
?><!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>LLM Connector Test</title><style>
 ...
 h1 { margin: 0 0 10px; font-size: 20px; color: rgb(255, 182, 65); }
 </style></head><body><div class="test-wrap"><h1> LLM Connector Test</h1><?php
 ...
 // Build a minimal in-game style test context.
 $head = [
 ...
 // Set connector globals expected by action parsing.
 ...
 // Styled timing summary for connector diagnostics.
 $perf = 'TOO SLOW'; $color = '#dc3545';
 ...
 // Any accumulated buffers/errors emitted by the connector.

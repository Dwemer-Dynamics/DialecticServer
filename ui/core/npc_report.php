...
if ($npcData) {
 ...
 $head = [];
 $prompt = [];
 $head[] = ['role' => 'system', 'content' => "You are a character assistant. Carefully read the evolution of the characters personality and write a report."];
...
$TITLE = " DIALECTIC - NPC Report";
ob_start();
include(__DIR__.DIRECTORY_SEPARATOR."../tmpl/head.html");
?><link rel="stylesheet" href="<?php echo $webRoot; ?>/ui/css/main.css"><style>
 /* Match worldknowledge_upload/api_badge page layout and colors */
 main {
 padding-top: 40px;
 padding-bottom: 40px;
 padding-left: 10%;
...
</style><main><h1 class="api-title">NPC Report<?php if ($npcName) { echo ' - '.htmlspecialchars($npcName); } ?></h1><div class="content-grid"><div class="content-section"><h2>Report</h2><div class="report-body"><?php 
 if ($pageError) {

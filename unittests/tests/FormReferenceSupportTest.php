...
final class FormReferenceSupportTest extends TestCase
{
    ...
    public function testGamePluginHelpersSupportStableReferences(): void
    {
        $this->assertSame(
            'MyMod.esp|000086EE',
            dialecticBuildStableFormReference('MyMod.esp', '86ee')
        );
        $this->assertSame(
            '020086EE',
            dialecticResolveStableFormReferenceToRuntimeFormId('MyMod.esp|000086EE')
        );

        $this->assertSame(
            'SomeLight.esl|00000822',
            dialecticBuildStableFormReference('SomeLight.esl', '822')
        );
        $this->assertSame(
            'FE123822',
            dialecticResolveStableFormReferenceToRuntimeFormId('SomeLight.esl|00000822')
        );
    }
